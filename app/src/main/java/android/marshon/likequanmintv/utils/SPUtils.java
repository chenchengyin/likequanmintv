...
/**
 * Created by Marshon.Chen on 2016/9/8.
 * DESC:
 */
...
public class SPUtils {
    ...
    public static String getFictionId(){
        String fid = getInstance().getString("fid","");
        LogUtil.d("fid:" +fid);
        return fid;
    }
    public static void setFictionId(String id){
        getInstance().putString("fid",id);
    }
    ...
    public static String getUserId(){
        String uid = getInstance().getString("uid");
        LogUtil.d("uid:" +uid);
        return uid;
    }
    public synchronized static void setUserId(String uid){
        getInstance().putString("uid",uid);
    }
